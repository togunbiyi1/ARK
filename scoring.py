...
class BulkScoring:
    def __init__(self, data_dir):
        ...
        self.bio_df = pd.read_csv('{}/bio_df.csv'.format(data_dir))
        self.pref_df = pd.read_csv('{}/pref_df.csv'.format(data_dir))
        self.int_df = pd.read_csv('{}/int_df.csv'.format(data_dir))
        self.habit_df = pd.read_csv('{}/habit_df.csv'.format(data_dir))
        self.pers_df = pd.read_csv('{}/pers_df.csv'.format(data_dir))
        self.flat_df = pd.read_csv('{}/flat_df.csv'.format(data_dir))
        self.extra_df = pd.read_csv('{}/extra_df.csv'.format(data_dir))
    ...
    def run_bulk_scoring(self):
        ...
        try:
            ...
            scoring_logger.error("Error in run_data_manager: {}".format(e))
            raise e
